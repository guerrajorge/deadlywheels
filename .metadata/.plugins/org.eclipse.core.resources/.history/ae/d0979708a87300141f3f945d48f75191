package groupa.deadlywheels.utils;
 ...
 * <b>Description:</b> <br>
 * <p>
 * Class System Properties - Contains constants and Common Methods to System
 * </p>
 * 
 */
public class SystemProperties {
	/**
	 * Key to Pass Data Between Activities - Number of port ( as for Both Client
	 * to Server ) # Client: Device remote control # Server: device to car
	 */
	public static final String KEY_PORT_NUMBER = "port_num";

	/**
	 * Key to Pass Data Between Activities - IP address of the server ( Device
	 * in Car )
	 */
	public static final String KEY_IP_ADDRESS = "ip_address";

	/**
	 * Chave para Passagem de Dados retornados via Intent - MAC address do
	 * dispositivo Bluetooth
	 */
	public static final String KEY_DEVICE_ADDRESS = "device_address";

	/**
	 * Request Code para Validar a Intent retornada da Lista de Dispositivos
	 * Bluetooth
	 */
	public static final int REQUEST_CODE_CONNECT_BLUETOOTH = 1;

	/**
	 * Request Code para Validar a Intent retornada da habilita��o do Bluetooth
	 * do Dispositivo
	 */
	...
	/**
	 * Nome da base de dados de propriedades a ser atribuido em
	 * CarDroiDuinoDbAdapter
	 */
	public static final String DATABASE_NAME = "data";

	/**
	 * Nome da tabela de propriedades a ser criada na base de dados em
	 * CarDroiDuinoDbAdapter
	 */
	...
	/**
	 * Property ID - IP address of the Server
	 */
	 ...
	 */
	public static final String PROPERTIE_DEFAUL_VAL_IPADDRESS_SERVER_1 = "192.168.100.100";
	...
	/**
	 * Jorge's first phone ip address
	 */
	public static final String PROPERTIE_DEFAUL_VAL_IPADDRESS_CLIENT_1 = "192.168.100.101";
	
	/**
	 * Jonathan's first phone ip address
	 */
	public static final String PROPERTIE_DEFAUL_VAL_IPADDRESS_CLIENT_2 = "192.168.100.103";
	...
	public static final String TABLE_CREATE = "create table " + DATABASE_TABLE
			+ " (" + DATABASE_FIELD_ID + " integer primary key, "
			+ DATABASE_FIELD_PROP + " text not null, " + DATABASE_FIELD_DESC
			+ " text not null);";
	...
	/**
	 * Comando para Controlar o Carrinho - Virar para Esquerda Composi��o:
	 * E<grau a virar - de 0 � 90 graus> Por exemplo: E56 --> Virar 56 graus �
	 * esquerda
	 */
	public static final String COMANDO_ESQUERDA = "E";

	/**
	 * Comando para Controlar o Carrinho - Virar para Direita Composi��o: D<grau
	 * a virar - de 0 � 90 graus> Por exemplo: D45 --> Virar 45 graus � direita
	 */
	...
	/**
	 * Comando para Controlar o Carrinho - Troca de Marcha Composi��o: M<numero
	 * da marchar - de 00 � 03> Por exemplo: M3 --> Terceira marcha (ou PWM com
	 * 100% de Ciclo de Trabalho)
	 */
	public static final String COMANDO_MARCHA = "MC";

	/**
	 * Prefixo Usado por Todos os Comandos Internos Destinados a executar
	 * fun��es dentro dos Dispositivos Android
	 */
	public static final String COMANDO_INTERNO_PREFIXO = "I_";

	/**
	 * Comando Interno para controle de fun��es dos Dispositivos Android -
	 * Ligar/Desligar Lanterna do Flash
	 */
	public static final String COMANDO_LANTERNA_SERVER = COMANDO_INTERNO_PREFIXO
			+ "LANTE";
	...
	/**
	 * Delay para a Thread Resolvedora de Comandos Internos dos Dispositivos
	 * Android
	 */
	 ...
	 * Utilizado caso o calculo do ponto d� um valor incossistente com o fundo
	 * de escala
	 */
	...
	/**
	 * Threshold do Eixo Z - Limiar da diferen�a entre os valores lidos para se
	 * determinar uma leitura
	 */
	public static final float CONTROLE_EIXO_Z_THRESHOLD = (float) 0.5;// 0.1;

	/**
	 * Threshold do Eixo Y - Limiar da diferen�a entre os valores lidos para se
	 * determinar uma leitura
	 */
	public static final float CONTROLE_EIXO_Y_THRESHOLD = (float) 0.2;

	/**
	 * N�mero de Leituras no primeiro Acumulado do Eixo Z - para o controle
	 * direcional
	 */
	public static final float CONTROLE_EIXO_Z_QTD_LEITURAS_1 = 7;

	/**
	 * N�mero de Leituras no segundo Acumulado do Eixo Z - para o controle
	 * direcional
	 */
	public static final float CONTROLE_EIXO_Z_QTD_LEITURAS_2 = 7;

	/**
	 * N�mero de Leituras no primeiro Acumulado do Eixo Y - para o controle
	 * direcional
	 */
	public static final float CONTROLE_EIXO_Y_QTD_LEITURAS_1 = 2;

	/**
	 * N�mero de Leituras no segundo Acumulado do Eixo Y - para o controle
	 * direcional
	 */
	public static final float CONTROLE_EIXO_Y_QTD_LEITURAS_2 = 2;

	/**
	 * C�digos das marchas na de acordo com o Numero das passagens Posicao 0: N
	 * --> Neutra Posicao 1: G --> Primeira Marcha Posicao 2: H --> segunda
	 * Marcha Posicao 3: I --> Terceira Marcha
	 */
	public static final String[] COMANDO_MARCHA_CARACTERES = { "N", "G", "H",
			"I" };
	...
	/**
	 * Tamanho do Buffer de recebimento para os Dados de Controle encaminhados
	 * ao Server
	 */
