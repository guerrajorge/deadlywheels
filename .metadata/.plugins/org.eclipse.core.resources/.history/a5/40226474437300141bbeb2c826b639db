    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId()){
            case 10: //Id del men�, para combrobar que se ha pulsado
            	anchoCamara = 1280;
            	altoCamara = 720;
            	Toast toast = Toast.makeText(this, "Resolucion del HUD maxima" , Toast.LENGTH_LONG);
        		toast.show();
                break;
            case 11:
            	anchoCamara = 960;
            	altoCamara = 720;
            	toast = Toast.makeText(this, "Resolucion del HUD media" , Toast.LENGTH_LONG);
        		toast.show();
                break;
            case 12:
            	anchoCamara = 800;
            	altoCamara = 480;
            	toast = Toast.makeText(this, "Resolucion del HUD m�nima" , Toast.LENGTH_LONG);
        		toast.show();
                break;
