 ...
 * <b>Descricao:</b> 
 * <br> 
 * <p> Classe que implenta o Gate de Comunica��o via TCP/IP (Socket) para o Servidor do Carrinho
...
public class DatagramSocketServerGate {
	...
	/**
	 * Thread Trabalhadora que Receber� os dados Vindos do Controle 
	 * e encaminhar� para o Core do Sistema
	 */
	...
	/**
	 * Thread Trabalhadora que enviar� os dados de video para o Controle
	 */
	 ...
	 * @param msgPromptHandler Manipulador para enviar msgs a Interface Gr�fica
	 * @throws IOException
	 */
	...
	/**
	 * Inicializa o Gate - Abre o Socket - Recebe a Conex�o do Client -
